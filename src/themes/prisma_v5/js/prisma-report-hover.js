...
(function() {
    function initPrismaReportHover() {
        ...
        // Criar o container do tooltip flutuante caso não exista
        ...
        // Delegar evento de mouseenter para linhas de tabelas de relatórios
        $(document).on('mouseenter', 'table tr, .table tr', function(e) {
            ...
            // Extrair células da linha hover
            ...
            $cells.each(function(idx) {
                ...
                // Ignorar colunas vazias ou botões/ícones de ação
            ...
            // Destacar a linha com brilho roxo sutil

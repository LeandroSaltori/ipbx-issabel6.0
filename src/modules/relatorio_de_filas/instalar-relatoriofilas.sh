#!/bin/bash
# ==============================================================================
# Script de Instalação Automatizada - Relatório de Filas IPbx Prisma (Issabel 5)
# ==============================================================================
...
# 2. Instalação de dependências essenciais (git, sox, lame, etc.)
...
TMP_REPO="/tmp/ipbx-issabel5-install"
rm -rf "$TMP_REPO"
...
if [ -d "$TMP_REPO/Relatorio_queue_stats/issabel  5/Relatorio_de_filas" ]; then
  cp -rf "$TMP_REPO/Relatorio_queue_stats/issabel  5/Relatorio_de_filas/"* "$TARGET_DIR/"
elif [ -d "$TMP_REPO/issabel  5/Relatorio_de_filas" ]; then
  cp -rf "$TMP_REPO/issabel  5/Relatorio_de_filas/"* "$TARGET_DIR/"

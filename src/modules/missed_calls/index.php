...
function renderDestinationBadge($raw_dst, $raw_src = '', $entities = array(), $contactsMap = array(), $stats7d = array(), $did = '') {
    ...
    $formatted_dst = formatPhoneBrMc($raw_dst);
                ...
                <tbody>
                    <?php if (count($rows) > 0): ?>
                        ...
                        <?php foreach ($rows as $r): ?>
                            ...
                            $raw_dst = !empty($r['dst']) ? $r['dst'] : '-';
                            $val_dst_html = renderDestinationBadge($raw_dst, $raw_src, $entitiesMaps, $abContactsMap, $stats7dMap);
                            ?>
                            <tr>

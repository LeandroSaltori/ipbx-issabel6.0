...
$strUser = "admin"; #usuario administrador do asterisk mysql
$strSecret = "ls251289"; #senha usuario administrador do asterisk mysql
...
$strWaitTime = "30"; #tempo de esperar para desligar a chamada
$strPriority = "1";
$strMaxRetry = "2"; #quantidade maxima de tentativas
...
//OPEN CNAM LOOKUP
//$callerid = @file_get_contents("https://api.opencnam.com/v2/phone/".$number) or $callerid = "Web IPbx";
$callerid = @file_get_contents("https://api.opencnam.com/vadmin 2/phone/".$number) or $callerid = "Web IPbx - $number";
...
echo "Ramal $strChannel esta em uso $number." ;
else :
exit() ;
endif ;
?>

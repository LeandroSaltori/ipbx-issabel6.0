...
$appconfig['dayp'][0]=_('Domingo');
$appconfig['dayp'][1]=_('Segunda');
$appconfig['dayp'][2]=_('Terca');
$appconfig['dayp'][3]=_('Quarta');
$appconfig['dayp'][4]=_('Quinta');
$appconfig['dayp'][5]=_('Sexta');
$appconfig['dayp'][6]=_('Sabado');
$appconfig['db']=$db;
...
<div id="asterniccontents">
    ...
    <tr>
        <td valign=top width='50%'>
            ...
            <caption><?php echo _('Informacoes do Relatorio')?></caption>
            <tbody>
            <tr>
                   <td><?php echo _('Data inicial')?>:</td>
                   <td><?php echo $start_parts[0]?></td>
            </tr>
            </tr>
            <tr>
                   <td><?php echo _('Data final')?>:</td>
                   <td><?php echo $end_parts[0]?></td>
            </tr>
            <tr>
                   <td><?php echo _('Periodo')?>:</td>
                   <td><?php echo $appconfig['period']?> <?php echo _('dias')?></td>
            </tr>
            </tbody>
            </table>
        </td>
...
<?php
	...
	echo "<hr/><table>\n";
	echo "<caption>"._('Distribuicao de Chamadas por Hora')."</caption>";
	echo "<thead>"; 
	echo "<tr>";
	echo "<th>"._('Hora')."</th>";
	echo "<th>"._('Quantidade de Chamadas')."</th>";
	echo "<th>"._('Duracao')."</th>";
	echo "</tr></thead>\n";
	echo "<tbody>";
    ...
    echo "</tbody></table><br/>";
    $query1.="title="._('Distribuicao de chamadas por hora')."$graphcolor";
...
function inbound_outbound($type,$appconfig) {
    ...
    $rep_title = "Chamadas de Entrada / Saida";
    ...
    <tr>
        <td valign=top width='50%'>
            ...
            <td valign=top width='50%'>
                ...
                <tbody>
                <tr> 
                  <td><?php echo _('Numero de Chamadas')?>:</td>
                  <td><?php echo $total_calls?> <?php echo _('ligacoes')?></td>
                </tr>
                <tr>
                  <td><?php echo _('Tempo Total')?>:</td>
                  <td><?php echo $total_bill_print?></td>
                </tr>
                <tr>
                  <td><?php echo _('Medio de Toques')?>:</td>
                  <td><?php echo $avg_ring_full?> <?php echo _('segs')?> </td>
                </tr>
                </tbody>
                </table>
            </td>
...
?>
        ...
        <?php echo _($rep_title) ?>
           ...
           <tr>
                  ...
                  <th><?php echo _('Saida')?></th>
                  <th><?php echo _('Completadas')?></th>
                  <th><?php echo _('Perdidas')?></th>
                  <th><?php echo _('% Perdidas')?></th>
                  <th><?php echo _('Duracao')?></th>
                  <th><?php echo _('%')?> <?php echo _('Duracao')?> </th>
                  <th><?php echo _('Duracao Media')?></th>
                  <th><?php echo _('Tempo Total de Toque')?></th>
                  <th><?php echo _('Tempo Medio de Toque')?></th>
            </tr>            </thead>
    ...
    foreach($billsec as $idx=>$key) {
        echo "<tbody>\n";
            if(count($appconfig['departments'])>1) {
                ...
                $texto .= "</tr>";
                $texto .= "<tr>";
                $texto .= "  <td>"._('Sem chamadas').":</td>";
                $texto .= "  <td>".$group_calls[$idx]." "._('ligacoes')."</td>";
                $texto .= "</tr>";
                $texto .= "<tr>";
                $texto .= "  <td>"._('Tempo total').":</td>";
                $texto .= "  <td>$group_bill_print</td>";
                $texto .= "</tr>";
                $texto .= "<tr>";
                $texto .= "  <td>"._('Tempo médio de toque').":</td>";
                $texto .= "  <td>$avg_ring_group "._('segs')." </td>";
                $texto .= "</tr>";
                $texto .= "</tbody>";
                $texto .= "</table>";
			...
			_('Perdidas'),
			_('Percentual'),
			_('Segundos faturados'),
			_('Percentual'),
			_('Tempo medio de chamada'),
			_('Tempo de toque'),
			_('Media de toque')            );
           ...
           $query1.="title="._($rep_title)."$graphcolorstack&tagA="._('Completadas')."&tagB="._('Perdidas');
           $query2.="title=Duracao Total de Chamadas por Usuario"."$graphcolor";
	   $query3.="title=Chamadas Recebidas/Efetuadas por Usuario"."$graphcolorstack&tagA=$tagA&tagB=$tagB";

    }
    echo "</tbody>\n";
    echo "</table>\n";

	$cover_pdf = _('Informacoes do Relatorio')."\n";
	$cover_pdf.= _('Data Inicial').": ".$start_parts[0]."\n";
	$cover_pdf.= _('Data Final').": ".$end_parts[0]."\n";
	$cover_pdf.= _('Periodo').": ".$appconfig['period']." "._('dias')."\n\n";
	$cover_pdf.= $rep_title."\n";
	$cover_pdf.= _('Quantidade de Chamadas').": ".$total_calls." "._('chamadas')."\n";
	$cover_pdf.= _('Tempo Total').": ".$total_bill_print." "._('min')."\n";
	$cover_pdf.= _('Tempo medio de toque').": ".$avg_ring_full." "._('seg')."\n";
...
if($typereport=="outgoing") {
        ...
        $otherchanfield = "channel";
        $typerecord="incoming";
        $rep_title = _('Chamadas de Entrada');
        $tagB=_("Saida");
        $tagA=_("Entrada");
    }
...
<div id="asterniccontents">
    ...
    <tr>
        <td valign=top width='50%'>
            ...
            <tr>
                   <td><?php echo _('Periodo')?>:</td>
                   <td><?php echo $appconfig['Periodo']?> <?php echo _('dias')?></td>
            </tr>
            </tbody>
            </table>
            ...
            <td valign=top width='50%'>
                ...
                <tbody>
                <tr> 
                  <td><?php echo _('Numero de Ligacoes')?>:</td>
                  <td><?php echo $total_calls?> <?php echo _('ligacoes')?></td>
                </tr>
                <tr>
                  <td><?php echo _('Tempo Total')?>:</td>
                ...
                <tr>
                  <td><?php echo _('Tempo medio de toques')?>:</td>
                  <td><?php echo $avg_ring_full?> <?php echo _('segs')?> </td>
                </tr>
                </tbody>
                </table>
...
?>
        ...
        <?php echo _($rep_title) ?>
            ...
            <thead>
	    <tr>
                  <th><?php echo _('Ramal/Usuario')?></th>
                  <th><?php echo _('Total')?></th>
                  <th><?php echo _('Completadas')?></th>
                  <th><?php echo _('Perdidas')?></th>
                  <th><?php echo _('% Perdidas')?></th>
    ...
    foreach($billsec as $idx=>$key) {
        echo "<tbody>\n";
            if(count($appconfig['departments'])>1) {
                ...
                $texto .= "</tr>";
                $texto .= "<tr>";
                $texto .= "  <td>"._('Tempo medio de toques').":</td>";
                $texto .= "  <td>$avg_ring_group "._('segs')." </td>";
                $texto .= "</tr>";
                $texto .= "</tbody>";
                $texto .= "</table>";
           ...
           foreach($key as $chan=>$val) {
                ...
                echo "<td>$percentage_bill "._('%')."</td>\n";
                echo "<td>$avg_duration_print</td>\n";
                echo "<td>$ring_time "._('segs')."</td>\n";
                echo "<td>$avg_ring_time "._('segs')."</td>\n";
                echo "</tr>\n";
           ...
           //$query1.="title=".$rep_title."$graphcolor";
           $query1.="title="._($rep_title)."$graphcolorstack&tagA="._('Completadas')."&tagB="._('Perdidas');
           $query2.="title="._('Duracao total da chamada por usuario')."$graphcolor";
           $query3.="title="._('Chamadas recebidas/efetuadas por usuario')."$graphcolorstack&tagA=$tagA&tagB=$tagB";

    }
    echo "</tbody>\n";
    echo "</table>\n";

$cover_pdf = 'Informacoes do Relatorio'."\n";
$cover_pdf.= 'Data Inicial'.": ".$start_parts[0]."\n";
$cover_pdf.= 'Data Final'.": ".$end_parts[0]."\n";
$cover_pdf.= 'Periodo'.": ".$appconfig['Periodo']." "."dias"."\n\n";
$cover_pdf.= $rep_title."\n";
$cover_pdf.= 'Numero de Chamadas'.": ".$total_calls." "."chamadas"."\n";
$cover_pdf.= 'Tempo Total'.": ".$total_bill_print." "."min"."\n";
$cover_pdf.= 'Tempo medio de toque'.": ".$avg_ring_full." "."seg"."\n";
...
<br/>
    ...
    <tr>
        <td valign=top width='50%'>
            <table width='100%' border=0 cellpadding=0 cellspacing=0>
                <caption>Contadores de Chamadas</caption>
                <tbody>
                <tr>
                ...
                <tr>
                   <td>Chamadas Efetuadas:</td>
                   <td><?php echo $outbound?></td>
                </tr>
                <tr>
                   <td>Chamadas Internas:</td>
                   <td><?php echo $internal?></td>
                </tr>
                <tr>
                   <td>Chamadores Unicos:</td>
        ...
        <td valign=top width='50%'>
    <table width='100%' border=0 cellpadding=0 cellspacing=0>
        <caption>Duracao das Chamadas</caption>
        <tbody>
        <tr> 
            <td>Minutos Totais:</td>
            <td><?php echo $totaltime ?></td>
        </tr>
        <tr>
            <td>Minutos Recebidos Totais:</td>
            <td><?php echo $totalinboundtime ?></td>
        </tr>
        <tr>
            <td>Minutos Efetuados Totais:</td>
            <td><?php echo $totaloutboundtime ?> </td>
        </tr>
        <tr>
            <td>Minutos Internos Totais:</td>
            <td><?php echo $totalinternaltime ?> </td>
        </tr>
        <tr>
            <td>Duracao Media Chamadas Recebidas:</td>
            <td><?php echo $avgtimein." "."minutos"  ?> </td>
        </tr>
        <tr>
            <td>Duracao Media Chamadas Efetuadas:</td>
            <td><?php echo $avgtimeout." "."minutos"  ?> </td>
        </tr>
        <tr>
            <td>Duracao Media Chamadas Internas:</td>
            <td><?php echo $avgtimeinternal." "."minutos"  ?> </td>
        </tr>
        </tbody>
    </table>
</td>
...
<div id='left'>
<h2>
<?php echo _('Selecione os Ramais');?>
</h2>
<br/>
...
<td>
        ...
        echo "<option value=\"MWJ_DOWN\">mais antigos</option>\n";
        ...
        echo "<option value=\"MWJ_UP\">mais recentes</option>\n";
        ?>
        </select>
</td></tr>
<tr>
...
<div id='rest'>
<br/>
<input type=submit name='runreport' class='button is-small is-rounded' value='<?php echo _('Gerar Relatorio')?>' onClick='return envia();'>

...
<?php
    ...
    foreach($billsec as $idx=>$key) {
        echo "<tbody>\n";
           ...
           $query2.="title="._('Duração total da chamada por usuario')."$graphcolor";
           $query3.="title="._('Chamadas recebidas/efetuadas por usuário')."$graphcolorstack&tagA=$tagA&tagB=$tagB";

...
| :--- | :--- | :--- |
| **Server Address (Endereço do Servidor)** | `cliente.ipbxprisma.cloud` *(ou IP do PBX)* | Domínio FQDN ou IP do servidor PBX do cliente |
...
| **Password (Senha)** | `Prisma@500` | Senha padronizada globalmente em `/etc/sysconfig/issabel-ldap` |
